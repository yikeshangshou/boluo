 ...
 * @since Sep 17, 2014
 */
public abstract class AbstractSyncTask implements Runnable {
  private static final Log LOG = LogFactory.getLog(AbstractSyncTask.class);
  ...
  public abstract List<Entity> getTasks();

  public abstract int processTask(Entity source) throws Throwable;

  @Override
  public void run() {
    List<Entity> sources = getTasks();
    ...
    for (Entity source : sources) {
      LOG.info("Sync soruce " + source.getString("url"));
      ...
      try {
        ...
        LOG.error("Sync source failed! " + source.getString("url"), t);
      }
    }
