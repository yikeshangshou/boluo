    ...
    <div class="col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form action="/api/v1/user" class="form-horizontal" id="signup-form" method="post" name="signup-form">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label" for="securityCode">手机验证码</label>
              <div class="col-sm-3">
            ...
            <div class="form-group">
              <div class="col-sm-6 col-sm-offset-3">
                <button class="btn btn-primary" tabindex="6" type="submit">注册</button>
...
<script src="/js/user.js?v=20160801"></script>