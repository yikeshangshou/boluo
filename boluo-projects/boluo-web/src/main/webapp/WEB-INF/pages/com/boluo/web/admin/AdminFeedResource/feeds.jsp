...
<div class="container row-space-top-2">
  <ol class="breadcrumb">
    <li><a href="/admin/feed">所有</a></li>
    <li><a href="/admin/feed?source=Instagram">Instagram</a></li>
    <li><a href="/admin/feed?source=Twitter">Twitter</a></li>
    <li><a href="/admin/feed?source=User">用户投稿</a></li>
    <li><a href="/admin/feed?source=36Kr">36Kr</a></li>
    <li><a href="/admin/feed?source=QQ">QQ</a></li>
    <li><a href="/admin/feed?source=Sina">新浪科技</a></li>
    <li><a href="/admin/feed?source=Zaker">Zaker</a></li>
  </ol>
  <div class="row row-space-top-4">
    <c:forEach var="item" items="${feeds}">
      <div class="col-md-3 col-sm-4 col-xs-6 feed" id="feed_${item.id}">
        <div class="panel panel-default" data-description="${item.description}" data-id="${item.id}" data-image="${item.image}" data-imageUrl="http://wfenxiang.b0.upaiyun.com/${item.image}!M"
          data-link="${item.link}" data-title="${item.title}">
  ...
  <div class="row">
    <div class="col-md-12">
      <ul class="pagination">
        <li><a href="/admin/feed?page=1">首页</a></li>
        <c:forEach var="page" items="${requestScope.pages}">
          <c:choose>
            ...
            <c:otherwise>
              <li><a href="/admin/feed?page=${page}">${page}</a></li>
            </c:otherwise>
          </c:choose>
        </c:forEach>
        <li><a href="/admin/feed?page=${lastPage}">尾页</a></li>
      </ul>
    </div>
  </div>
</div>
      ...
      <form action="/admin/feed/remove" class="form-horizontal" id="remove-form" method="post" name="remove-form" role="form">
        <div class="modal-body">
          <div class="form-group">
            <label class="col-md-2 control-label" for="remove-title">标题</label>
            <div class="col-md-8">
    ...
    <div class="modal-content">
      ...
      <form action="/admin/feed/publish" class="form-horizontal" id="publish-form" method="post" name="publish-form" role="form">
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="col-md-12">
              <textarea class="form-control" id="publish-description" name="description" placeholder="描述" rows="3"></textarea>
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-10">
